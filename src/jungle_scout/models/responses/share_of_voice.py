...
class ShareOfVoiceBrands(BaseModel):
    ...
    combined_products: str = Field(default=..., description="The combined products.")
    ...
    organic_products: str = Field(default=..., description="The organic products.")
    ...
    sponsored_products: str = Field(default=..., description="The sponsored products.")
...
class ShareOfVoiceAttributes(BaseModel):
    ...
    exact_suggested_bid_median: float = Field(default=..., description="The median of the exact suggested bid.")
